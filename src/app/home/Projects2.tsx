  ...
  return (
    ...
    >
      <div className='max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0'>
        ...
        >
          As I mentioned earlier, my enthusiasm for computer science sometimes leads me to dive
          into my own projects in my spare time. Starting with this portfolio, 
          which I built from scratch, here are a few highlights of what I've created!
        </div>
      </div>
      <motion.div
        style={{
        ...
        <motion.div className='flex flex-row-reverse space-x-reverse space-x-20 mb-20'>
          {projects.map((row) => (
            <motion.div
              ...
              style={{ x: translateX }}
              // whileHover={{ y: 50 }}
              className='group/product h-[30rem] w-[60rem] relative flex-shrink-0 bg-black hover:border-2 hover:border-teal-300'
            >
              <Link
                href={row.link}
